...
window.App.BodySchema = {
	...
	vx: { default: 0, label: 'Velocity X', tip: 'Current velocity on X axis.', type: 'number', constraint: 'default', prec: 3, inputId: 'newVX' },
	vy: { default: 0, label: 'Velocity Y', tip: 'Current velocity on Y axis.', type: 'number', constraint: 'default', prec: 3, inputId: 'newVY' },
	ax: { default: 0, label: 'Acceleration X', tip: 'Constant acceleration on X axis.', type: 'number', constraint: 'default', prec: 3, inputId: 'newAX', internal: 'startAx' },
	ay: { default: 0, label: 'Acceleration Y', tip: 'Constant acceleration on Y axis.', type: 'number', constraint: 'default', prec: 3, inputId: 'newAY', internal: 'startAy' },
	charge: { default: 0, label: 'Charge', tip: 'Body electric charge.', type: 'number', constraint: 'default' },
	...
	temperature: { default: 293, label: 'Temperature', tip: 'Body temperature in Kelvin.', type: 'number', constraint: 'non-negative', prec: 0 },
	...
	criticalTemp: { default: 1000, label: 'Crit. Temp', tip: 'Temperature for material property change.', type: 'number', constraint: 'non-negative', prec: 0, inputId: 'newCriticalTemp' },
